...
readingMinutes: 7
faq:
  - q: "What are my options if my children do not want the business?"
    a: "Broadly four. Sell to a trade buyer or competitor. Sell to a financial buyer such as private equity or a search fund. Sell to your own management team, usually with external funding. Or wind the business down, which almost always realises the least. A sale to an external party is the most common outcome for Singapore SMEs where the next generation has other plans, and it usually produces a better result than waiting for them to change their minds."
  - q: "When should I start succession planning?"
    a: "Earlier than feels necessary, ideally five years out and no later than two. The reason is leverage. An owner who plans ahead chooses the timing, prepares the business and negotiates from strength. An owner who has run out of energy or health is negotiating from a position buyers can see, and it shows in the terms."
  - q: "Can I sell part of the business and stay involved?"
    a: "Yes. Partial sales, where a buyer takes a majority and the founder retains a stake, are common and can suit an owner who wants liquidity without a complete exit. It can also produce a second payment later if the business grows under new ownership. The point to negotiate carefully is what your minority position actually entitles you to, and how you eventually exit it."
  - q: "Is a management buyout realistic for a Singapore SME?"
    a: "It can be, where the management team is genuinely capable and external funding is available. The constraint is usually money rather than ability, since managers rarely have the capital personally. These deals often involve a bank, a financial partner, or vendor financing from the seller, which means you may be paid over time rather than at completion. Whether that is acceptable is the first question to settle."
draft: false
reviewed: true
updated: 2026-08-31
---
